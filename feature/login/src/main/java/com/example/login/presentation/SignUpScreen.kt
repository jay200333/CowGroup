...
fun SignUpScreen(
    ...
    SignUpScreen(
        ...
        updateAuthCode = { authCode -> viewModel.updateAuthCode(authCode) },
        ...
        sendAuthCode = viewModel::sendAuthCode,
        checkAuthCode = viewModel::checkAuthCode,
